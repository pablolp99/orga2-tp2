...
IMAGENES=["EternalSunshineOfTheSpotlessMind.bmp","FightClub.bmp","HardCandy.bmp","InglouriousBasterds.bmp","Labyrinth.bmp","LaViteEBella.bmp","Leon.bmp","LoveActually.bmp","NottingHill.bmp","PetSematary.bmp","PulpFiction.bmp"]
